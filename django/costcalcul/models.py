...
class Ingredient(models.Model):
    ...
    store = models.ForeignKey(Store, related_name='ingredients', on_delete=models.CASCADE, null=True, blank=True)
...
class RecipeItem(models.Model):
    ...
    unit = models.CharField(max_length=2, choices=Ingredient.UNIT_CHOICES)
