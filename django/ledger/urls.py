...
from .views import TransactionSummaryView, TransactionDetailView, CategoryView, CategoryDetailView

urlpatterns = [
    # 거래 내역 목록 조회 및 생성 엔드포인트 (GET: 목록 조회, POST: 새 거래 생성)
    path('transactions/', TransactionSummaryView.as_view(), name='transaction-list-create'),
